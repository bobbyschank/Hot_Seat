...
import com.example.bobby.hotseat.UI.AutoRecordActivity;
...
public class VideoPlayer extends Activity implements
    ...
    private void playVideo(Integer Media) {
         ...
         */
            ...
            path = extras.get("fileUri").toString();
    ...
    public void onCompletion(MediaPlayer arg0) {
        ...
        Intent autoRecordIntent = new Intent(this, AutoRecordActivity.class);
